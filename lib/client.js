...
"marks.note.exists": "Has note",
    ...
    function SessionManagerPanel(props) {
      ...
      const moveDialog = moveFor === null ? null : h(MoveDialog, {
        ...
        /* Mirror the title-bar entry: always show the raw session id in the description so both move entry points render identically. (issue #17.2) */
        description: t("confirm.move.desc", { title: moveFor.id }),
